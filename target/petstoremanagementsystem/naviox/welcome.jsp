...
In petstoremanagementsystem-labels_en.properties:
petstoremanagementsystem=My application
petstoremanagementsystem[description]=My application does this and that

In petstoremanagementsystem-messages_en.properties:
